...
char* hello_str = malloc(6);
 ...
 hello_str[5] = '\0';
  ...
  char* world_str = malloc(strlen("world") + 1);
 ...
 char* static_world_str = "world";
  ...
  char* hello_world_str = malloc(strlen("hello world") + 1);
